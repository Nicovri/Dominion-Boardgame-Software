...
COMPONENTS := $(SFMLDIR)/Button.o $(SFMLDIR)/TextButton.o $(SFMLDIR)/ImageButton.o $(SFMLDIR)/ButtonGroup.o $(SFMLDIR)/TextInputField.o $(SFMLDIR)/Text.o
...
ACTION_CARDS := $(CARDSDIR)/Workshop.o $(CARDSDIR)/Woodcutter.o $(CARDSDIR)/Cellar.o $(CARDSDIR)/Chapel.o $(CARDSDIR)/Smithy.o $(CARDSDIR)/Market.o $(CARDSDIR)/Mine.o $(CARDSDIR)/Remodel.o $(CARDSDIR)/Village.o $(CARDSDIR)/Festival.o $(CARDSDIR)/Laboratory.o $(CARDSDIR)/Moneylender.o $(CARDSDIR)/CouncilRoom.o $(CARDSDIR)/Poacher.o $(CARDSDIR)/Feast.o $(CARDSDIR)/Artisan.o $(CARDSDIR)/Vassal.o $(CARDSDIR)/Sentry.o $(CARDSDIR)/Chancellor.o $(CARDSDIR)/Harbinger.o $(CARDSDIR)/Library.o $(CARDSDIR)/Merchant.o $(CARDSDIR)/ThroneRoom.o $(CARDSDIR)/Adventurer.o $(CARDSDIR)/Ironworks.o $(CARDSDIR)/MiningVillage.o $(CARDSDIR)/ShantyTown.o $(CARDSDIR)/TradingPost.o $(CARDSDIR)/Steward.o $(CARDSDIR)/Pawn.o $(CARDSDIR)/Lurker.o $(CARDSDIR)/Courtyard.o
...
REACTION_CARDS := $(CARDSDIR)/Moat.o $(CARDSDIR)/Diplomat.o
